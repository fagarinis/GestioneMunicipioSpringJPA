...
%>
	...
	<div class="container">
		...
		<form class="form-horizontal" action="ExecuteUpdateAbitanteServlet"
			method="post">
			<input type="hidden" id="nomeInputId" name="idAbitante"
				value=<%=abitante.getId() %>>
			<div class="form-group">
				<label class="control-label col-sm-2" for="nomeInputId">Nome:</label>
				<div class="col-sm-4">
					<input class="form-control" type="text" id="nomeInputId"
						name="nomeInput" value="<%=abitante.getNome() %>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="cognomeInputId"
						name="cognomeInput" value="<%=abitante.getCognome() %>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="etaInputId"
						name="etaInput" value="<%=abitante.getEta() %>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="indirizzoInputId"
						name="indirizzoInput" value="<%=abitante.getResidenza() %>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					<select class="form-control" name="idMunicipio">
						...
						<option <%if(m.getId() == abitante.getMunicipio().getId()){%>
							selected <%} %> class="form-control" value="<%=m.getId()%>">
							<%=m.getDescrizione() %>
						</option>
						<%} %>
